...
if(a>b){
	if(a>c){
		cout<<student1.name<<" has the greates marks of all "<<endl;
		cout<<"Marks obtained by "<<student1.name<<" are "<<a<<endl;
	}
}
if(b>c){
	if(b>a){
		cout<<student2.name<<" has the greates marks of all "<<endl;
			cout<<"Marks obtained by "<<student2.name<<" are "<<b<<endl;
	}
}
if(c>a){
	if(c>b){
		cout<<student3.name<<"Student 3 has the greates marks of all "<<endl;
			cout<<"Marks obtained by "<<student3.name<<" are "<<c<<endl;
	}
}
cout<<endl;
